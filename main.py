...
def obtener_respuesta(prompt):
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "Eres un analista financiero experto en el área de solvencia, vas a responder como un asistente que resuelve cualquier duda dobre análisis financiero. Contesta siempre en español en un máximo de 50 palabras."},
...
prompt = st.sidebar.text_area(
    ...
    placeholder="Este espacio es para que puedas hacer preguntas sobre análisis financiero."
)

# Obtener y mostrar el resultado
output = obtener_respuesta(prompt)

st.sidebar.info("Respuesta: " + output)